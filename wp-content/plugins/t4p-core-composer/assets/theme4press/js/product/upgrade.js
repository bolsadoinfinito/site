...
(function($) {
	...
	// Declare methods for Theme4press Update class
	t4p_upgrade.prototype = {
		install: function() {
		...
		step2: function () {
			...
			$.getJSON(
				$(this.button).attr('data-source') + '?action=t4p-check-edition' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + this.params.edition + '&' + $(document.JSNUpgradeLogin).serialize(),
		...
		step3: function() {
			...
			$.ajax({
				url: $(this.button).attr('data-source') + '?action=t4p-download-update' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + $('select', document.JSNUpgradeLogin).val(),
		...
		step4: function() {
			...
			$.ajax({
				url: $(this.button).attr('data-source') + '?action=t4p-install-update' + '&' + 'id=' + this.params.identified_name + '&' + 'edition=' + $('select', document.JSNUpgradeLogin).val(),
				context: this
			}).done(function(data) {
