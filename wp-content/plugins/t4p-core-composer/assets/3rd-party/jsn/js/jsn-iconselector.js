    ...
    function ($) {
        ...
        JSNIconSelector.prototype = {
            GenerateSelector:function (container, actionSelector, value) {
                ...
                self.renderListIconSelector(resultsFilter, self.FontAwesome(), actionSelector, value);
            ...
            renderListIconSelector:function ( container, list, actionSelector, valueDefault) {
                ...
                $(container).append(
                        $("<li/>", {'class': _nonIconClass}).append(
                            $("<a/>", {"href":"javascript:void(0)", "class":"icons-item t4p-tooltip-icon", "data-value":'', "data-original-title": ''}).append($("<i/>", {"class":'icon-'})).append('None').click(function () {
                                actionSelector(this);
                            })
                        )
                );
                ...
                $.each(list, function (value, title) {
                    ...
                    $(container).append(
                        $("<li/>", classActive).append(
                            $("<a/>", {"href":"javascript:void(0)", "class":"icons-item t4p-tooltip-icon", "data-value":value, "data-original-title": title}).append($("<i/>", {"class":"fa "+value})).click(function () {
                                actionSelector(this);
        ...
        $(document).ready(function() {
			...
			var add_tooltip = function () {
                if ( typeof ( $.fn.tooltip ) == 'function' ) {
                	$('.t4p-tooltip-icon').each(function () {
                    	$(this).tooltip({
                    		placement: 'top'
                    	});
                    });
