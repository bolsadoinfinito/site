...
jQuery( function ($){
	$(document).ready(function () {
		...
		$('#parent-param-video_youtube_show_list', $('#modalOptions')).removeClass('t4p_hidden_depend').addClass('t4p_hidden_depend');
		...
		function validate_file()
		{
			...
			audioxhr	= $.post(
            	...
            	if (data === 'false') {
            		...
            		if (res.type == 'list') {
            			$('#parent-param-video_youtube_show_list', $('#modalOptions')).removeClass('t4p_hidden_depend');
            		}else{
            			$('#parent-param-video_youtube_show_list', $('#modalOptions')).removeClass('t4p_hidden_depend').addClass('t4p_hidden_depend');
            		}
            	}
