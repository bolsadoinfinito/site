...
if ( ! class_exists( 'T4P_Pb_Init_Admin_Menu' ) ) :
...
class T4P_Pb_Init_Admin_Menu {
	 ...
	 *
	 * T4P_Pb_Init_Admin_Menu::add(
	 *     array(
	 *         'page_title' => 'T4P Sample - All Items',
	 *         'menu_title' => 'T4P Sample',
	 *         'capability' => 'edit_posts',
	 *         'menu_slug'  => 't4p-sample-all-items',
	 *         'function'   => 't4p_sample_all_items',
	 *         'children'   => array(
	 *             array(
	 *                 'page_title' => 'T4P Sample - All Items',
	 ...
	 *             ),
	 *             array(
	 *                 'page_title' => 'T4P Sample - Add New Item',
	 *                 'menu_title' => 'Add New',
	 *                 'capability' => 'edit_posts',
	 *                 'menu_slug'  => 't4p-sample-add-new',
	 *                 'function'   => 't4p_sample_add_new'
	 *             )
	 *         )
	 *     )
	 * );
	 ...
	 * Below is a sample use of this method:
	 *
	 * T4P_Pb_Init_Admin_Menu::replace(
	 *     'Dashboard',
	 *     array(
	...
	public static function admin_menu() {
		...
		self::$add = apply_filters( 't4p_pb_register_admin_menu', self::$add );
