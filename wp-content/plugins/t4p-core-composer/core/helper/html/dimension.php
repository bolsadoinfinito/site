 ...
 * @version        1.0.0
 */
class T4P_Pb_Helper_Html_Dimension extends T4P_Pb_Helper_Html {
	/**
	...
	static function render( $element, $input_params ) {
		...
		if ( in_array( 'w', $element['dimension_elements'] ) ) {
			...
			$output .= T4P_Pb_Helper_Shortcode::render_parameter( 'text_append', $_width );
			$output .= isset( $element[$_idx_width_unit] ) ? T4P_Pb_Helper_Shortcode::render_parameter( 'select', $_w_unit ) : '';
		}
		...
		if ( in_array( 'h', $element['dimension_elements'] ) ) {
			...
			$output .= T4P_Pb_Helper_Shortcode::render_parameter( 'text_append', $_height );
			$output .= isset( $element[$_idx_height_unit] ) ? T4P_Pb_Helper_Shortcode::render_parameter( 'select', $_h_unit ) : '';
		}
