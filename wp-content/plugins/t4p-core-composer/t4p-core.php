...
/**
 *
 * Plugin Name: Theme4Press Core + Composer
 * Plugin URI: http://www.theme4press.com
 * Description: Theme4Press Core + Composer Plugin for Theme4Press Themes
 * Version: 1.3.8
 * Author: Theme4Press
...
//Include Initialize T4P PageBuilder file
        include_once 't4p-pagebuilder.php';
