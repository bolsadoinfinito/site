...
$t4p_shortcodes['alert'] = array(
	...
	'params' => array(
		...
		'icon' => array(
			...
			'options' => $icons
                ...
                'show_icon' => array(
                    'type' => 'select',
                    'label' => __( 'Show Icon', 't4p-core' ),
                    'desc' =>  __( 'Display alert box icon or not', 't4p-core' ),
                    'options' => $choices
                ),
		'alert_close' => array(
			'type' => 'select',
			'label' => __( 'Allow to close', 't4p-core' ),
			'desc' =>  __( 'Display alert box close button or not', 't4p-core' ),
			'options' => $choices
		),
                'boxshadow' => array(
                    'type' => 'select',
		...
		'animation_speed' => array(
			...
			'options' => $dec_numbers,
                ...
                'div_margin_top' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Top', 't4p-core' ),
			'desc' => __( 'Spacing above the elements.', 't4p-core')
		),
                'div_margin_bottom' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Bottom', 't4p-core' ),
			'desc' => __( 'Spacing below the elements.', 't4p-core')
		),
                'div_margin_right' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Right', 't4p-core' ),
			'desc' => __( 'Spacing right the elements.', 't4p-core')
		),
                'div_margin_left' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Left', 't4p-core' ),
			'desc' => __( 'Spacing left the elements.', 't4p-core')
		),
		'class' => array(
			'std' => '',
			'type' => 'text',
	...
	'shortcode' => '[alert type="{{type}}" accent_color="{{accentcolor}}" background_color="{{backgroundcolor}}" border_size="{{bordersize}}" icon="{{icon}}" show_icon="{{show_icon}}" alert_close="{{alert_close}}" box_shadow="{{boxshadow}}" animation_type="{{animation_type}}" animation_direction="{{animation_direction}}" animation_speed="{{animation_speed}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{content}}[/alert]',
...
$t4p_shortcodes['button'] = array(
	...
	'params' => array(
		...
		'shape' => array(
			...
			'desc' => 'Choose how to align the button',
			'options' => array(
				'left' => 'Left',
				'right' => 'Right',
				'center' => 'Center'
...
$t4p_shortcodes['checklist'] = array(
	...
	'shortcode' => '[checklist icon="{{icon}}" circle="{{circle}}" size="{{size}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/checklist]',
...
$t4p_shortcodes['clientslider'] = array(
	...
	'shortcode' => '[clients picture_size="{{picture_size}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/clients]', // as there is no wrapper shortcode
...
$t4p_shortcodes['contentboxes'] = array(
	...
	'shortcode' => '[content_boxes layout="{{layout}}" columns="{{columns}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/content_boxes]', // as there is no wrapper shortcode
...
$t4p_shortcodes['countersbox'] = array(
	...
	'shortcode' => '[counters_box columns="{{columns}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/counters_box]', // as there is no wrapper shortcode
...
$t4p_shortcodes['counterscircle'] = array(
	...
	'shortcode' => '[counters_circle div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/counters_circle]', // as there is no wrapper shortcode
	...
	'child_shortcode' => array(
		'params' => array(
			...
			'size' => array(
				...
				'std' => '40',
				'type' => 'text',
				'label' => __( 'Font Size', 't4p-core' ),
				'desc' => __( 'Insert font size of the counter in px. ex: 40', 't4p-core' ),
			),
                    	'icon' => array(
				'type' => 'iconpicker',
				'label' => __( 'Icon', 't4p-core' ),
			...
			'content' => array(
				...
				'std' => '',
				'type' => 'text',
				'label' => __( 'Counter Circle Description', 't4p-core' ),
				'desc' => __( 'Insert description for counter circle box', 't4p-core' ),
			),
		),
		'shortcode' => '[counter_circle description="{{description}}" filledcolor="{{filledcolor}}" unfilledcolor="{{unfilledcolor}}" size="{{size}}" font_size="{{font_size}}" icon="{{icon}}" scales="{{scales}}" countdown="{{countdown}}" speed="{{speed}}" value="{{value}}"]{{content}}[/counter_circle]',
...
$t4p_shortcodes['postslider'] = array(
	...
	'shortcode' => '[postslider layout="{{type}}" excerpt="{{excerpt}}" category="{{category}}" limit="{{limit}}" id="" lightbox="{{lightbox}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"][/postslider]',
...
$t4p_shortcodes['flipboxes'] = array(
	...
	'shortcode' => '[flip_boxes columns="{{columns}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/flip_boxes]', // as there is no wrapper shortcode
...
$t4p_shortcodes['googlemap'] = array(
	...
	'shortcode' => '[map address="{{content}}" type="{{type}}" map_style="{{mapstyle}}" overlay_color="{{overlaycolor}}" infobox="{{infobox}}" infobox_background_color="{{infoboxbackgroundcolor}}" infobox_text_color="{{infoboxtextcolor}}" infobox_content="{{infoboxcontent}}" icon="{{icon}}" width="{{width}}" height="{{height}}" zoom="{{zoom}}" scrollwheel="{{scrollwheel}}" scale="{{scale}}" zoom_pancontrol="{{zoom_pancontrol}}" popup="{{popup}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"][/map]',
...
$t4p_shortcodes['imagecarousel'] = array(
	...
	'shortcode' => '[images picture_size="{{picture_size}}" lightbox="{{lightbox}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/images]', // as there is no wrapper shortcode
...
$t4p_shortcodes['imageframe'] = array(
	...
	'params' => array(
		...
		'alt' => array(
			...
			'type' => 'text',
			'label' => __( 'Margin Top', 't4p-core' ),
			'desc' => 'Spacing above the image frame'
		),
                'image_margin_bottom' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Bottom', 't4p-core' ),
			'desc' => 'Spacing below the image frame'
		),
                'image_margin_right' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Right', 't4p-core' ),
			'desc' => 'Spacing right the image frame'
		),
                'image_margin_left' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Margin Left', 't4p-core' ),
			'desc' => 'Spacing left the image frame'
		),
		'animation_type' => array(
			'type' => 'select',
			'label' => __( 'Animation Type', 't4p-core' ),
...
$t4p_shortcodes['progressbar'] = array(
	'params' => array(
		...
		'unfilledcolor' => array(
			...
			'type' => 'select',
			'label' => __( 'Show Icon', 't4p-core' ),
			'desc' => __( 'Choose to show icon or not.', 't4p-core' ),
			'options' => $choices
		),
            	'show_title' => array(
			'type' => 'select',
			'label' => __( 'Show Title', 't4p-core' ),
			'desc' => __( 'Choose to show title or not.', 't4p-core' ),
			'options' => $choices
		),
                'show_percent' => array(
			'type' => 'select',
			'label' => __( 'Show Percentage', 't4p-core' ),
			'desc' => __( 'Choose to show percentage or not.', 't4p-core' ),
			'options' => $choices
		),
		'striped' => array(
			'type' => 'select',
	...
	'shortcode' => '[progress percentage="{{percentage}}" unit="{{unit}}" filledcolor="{{filledcolor}}" unfilledcolor="{{unfilledcolor}}" icon="{{icon}}" show_icon="{{show_icon}}" show_title="{{show_title}}" show_percent="{{show_percent}}" striped="{{striped}}" animated_stripes="{{animatedstripes}}" textcolor="{{textcolor}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{content}}[/progress]',
...
$t4p_shortcodes['sectionseparator'] = array(
	...
	'shortcode' => '[section_separator divider_candy="{{divider_candy}}" icon="{{icon}}" icon_color="{{iconcolor}}" bordersize="{{border}}" bordercolor="{{bordercolor}}" backgroundcolor="{{backgroundcolor}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]',
...
$t4p_shortcodes['slider'] = array(
	...
	'shortcode' => '[slider width="{{size_width}}" height="{{size_height}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/slider]', // as there is no wrapper shortcode
...
ex: #AA0000|#00AA00|#0000AA. Leave blank for theme option selection.', 't4p-core' ),
	...
	'shortcode' => '[social_links icons_boxed="{{iconboxed}}" icons_boxed_radius="{{iconboxedradius}}" icon_colors="{{iconcolor}}" box_colors="{{boxcolor}}" tooltip_placement="{{icontooltip}}" rss="{{rss}}" facebook="{{facebook}}" twitter="{{twitter}}" dribbble="{{dribbble}}" google="{{google}}" linkedin="{{linkedin}}" blogger="{{blogger}}" tumblr="{{tumblr}}" reddit="{{reddit}}" yahoo="{{yahoo}}" deviantart="{{deviantart}}" vimeo="{{vimeo}}" youtube="{{youtube}}" pinterest="{{pinterest}}" digg="{{digg}}" flickr="{{flickr}}" forrst="{{forrst}}" myspace="{{myspace}}" skype="{{skype}}" paypal="{{paypal}}" dropbox="{{dropbox}}" soundcloud="{{soundcloud}}" vk="{{vk}}" email="{{email}}" show_custom="{{show_custom}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]',
...
$t4p_shortcodes['soundcloud'] = array(
	...
	'shortcode' => '[soundcloud url="{{url}}" comments="{{comments}}" auto_play="{{autoplay}}" color="{{color}}" width="{{width}}" height="{{height}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]',
	'popup_title' => __( 'Sharing Box Shortcode', 't4p-core' )
);
...
$t4p_shortcodes['tabs'] = array(
	...
	'shortcode' => '[t4p_tabs layout="{{layout}}" justified="{{justified}}" backgroundcolor="{{backgroundcolor}}" inactivecolor="{{inactivecolor}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/t4p_tabs]',
...
$t4p_shortcodes['testimonials'] = array(
	...
	'shortcode' => '[testimonials backgroundcolor="{{backgroundcolor}}" textcolor="{{textcolor}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/testimonials]',
...
$t4p_shortcodes['title'] = array(
	...
	'params' => array(
		...
		'sepcolor' => array(
			...
			'std' => '',
			'type' => 'text',
			'label' => __( 'Underline Padding', 't4p-core' ),
                        'desc' => __( 'Spacing above the underline.', 't4p-core')
		),
		'content' => array(
			'std' => '',
			'type' => 'textarea',
	...
	'shortcode' => '[title size="{{size}}" content_align="{{contentalign}}" style_type="{{separator}} {{sepstyle}}" sep_color="{{sepcolor}}" padding_bottom="{{padding_bottom}}" animation_type="{{animation_type}}" animation_direction="{{animation_direction}}" animation_speed="{{animation_speed}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{content}}[/title]',
	'popup_title' => __( 'Sharing Box Shortcode', 't4p-core' )
);
...
$t4p_shortcodes['toggles'] = array(
	...
	'params' => array(
        ...
        'shortcode' => '[accordian animation_type="{{animation_type}}" animation_direction="{{animation_direction}}" animation_speed="{{animation_speed}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]{{child_shortcode}}[/accordian]',
...
$t4p_shortcodes['tooltip'] = array(
	...
	'params' => array(
		...
		'content' => array(
			...
			'std' => '500',
			'type' => 'text',
			'label' => __( 'show', 't4p-core' ),
			'desc' => __( 'Set time (ms) to show tooltip when hover.', 't4p-core' )
		),
                'hide' => array(
			'std' => '100',
			'type' => 'text',
			'label' => __( 'hide', 't4p-core' ),
			'desc' => __( 'Set time (ms) hide tooltip when hover.', 't4p-core' )
		),
                'padding_top' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Padding Top', 't4p-core' ),
			'desc' => __( 'Spacing top the elements.', 't4p-core')
		),
                'padding_bottom' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Padding Bottom', 't4p-core' ),
			'desc' => __( 'Spacing bottom the elements.', 't4p-core')
		),
                'padding_left' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Padding Left', 't4p-core' ),
			'desc' => __( 'Spacing left the elements.', 't4p-core')
		),
                'padding_right' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Padding Right', 't4p-core' ),
			'desc' => __( 'Spacing right the elements.', 't4p-core')
		),
		'class' => array(
			'std' => '',
	...
	'shortcode' => '[tooltip title="{{title}}" placement="{{placement}}" trigger="{{trigger}}" show="{{show}}" hide="{{hide}}" padding_top="{{padding_top}}" padding_bottom="{{padding_bottom}}" padding_left="{{padding_left}}" padding_right="{{padding_right}}" class="{{class}}" id="{{id}}"]{{content}}[/tooltip]',
...
$t4p_shortcodes['vimeo'] = array(
	...
	'shortcode' => '[vimeo id="{{id}}" width="{{width}}" height="{{height}}" autoplay="{{autoplay}}" api_params="{{apiparams}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}"]',
...
$t4p_shortcodes['woofeatured'] = array(
	...
	'shortcode' => '[featured_products_slider div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]',
...
$t4p_shortcodes['wooproducts'] = array(
	...
	'shortcode' => '[products_slider picture_size="{{picture_size}}" cat_slug="{{cat_slug}}" number_posts="{{number_posts}}" show_cats="{{show_cats}}" show_price="{{show_price}}" show_buttons="{{show_buttons}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" id="{{id}}"]',
...
$t4p_shortcodes['youtube'] = array(
	...
	'shortcode' => '[youtube id="{{id}}" width="{{width}}" height="{{height}}" autoplay="{{autoplay}}" api_params="{{apiparams}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}"]',
...
$t4p_shortcodes['t4pslider'] = array(
	...
	'shortcode' => '[t4pslider id="{{id}}" div_margin_top="{{div_margin_top}}" div_margin_bottom="{{div_margin_bottom}}" div_margin_right="{{div_margin_right}}" div_margin_left="{{div_margin_left}}" class="{{class}}" name="{{name}}"][/t4pslider]',
