...
//$type = 2 is for buddypress.php and bbpress.php, which EXCLUDES the get_post_meta($post->ID, 'evolve_full_width', true)..  
        ...
        if ($evolve_layout == "1c") {
            ...
            if (($evolve_layout == "2cr" && ($evolve_post_layout == "two") || $evolve_layout == "2cl" && ($evolve_post_layout == "two"))) {
                $layout_css.= ' col-md-' . $evolve_opt1_width_content . '';
            }

            if (($evolve_layout == "3cm" || $evolve_layout == "3cl" || $evolve_layout == "3cr")) {
                $layout_css.= ' col-md-' . $evolve_opt2_width_content . '';
            } else {
                $layout_css.= ' col-md-' . $evolve_opt1_width_content . '';
            }
    ...
    function evolve_sidebar_class() {
        ...
        switch ($evolve_layout):
            ...
            case "2cr":
                ...
                break;
            case "3cm":
                $sidebar_css = 'col-xs-12 col-sm-6 col-md-' . $evolve_opt2_width_sidebar1 . '';
                break;
            case "3cl":
                $sidebar_css = 'col-xs-12 col-sm-6 col-md-' . $evolve_opt2_width_sidebar1 . '';
                break;
    ...
    function evolve_sidebar2_class() {
        ...
        switch ($evolve_layout):
            ...
            case "2cr":
                ...
                break;
            case "3cm":
                $sidebar_css = 'col-xs-12 col-sm-6 col-md-' . $evolve_opt2_width_sidebar2 . '';
                break;
            case "3cl":
                $sidebar_css = 'col-xs-12 col-sm-6 col-md-' . $evolve_opt2_width_sidebar2 . '';
                break;
...
// Custom RSS Link
    ...
    /* store evolve bootstrap slider when evolve plus active */
    add_action('switch_theme', 'evolve_theme_setup_options');

    function evolve_theme_setup_options() {
        ...
        for ($a = 0; $a < 5; $a++) {
            ...
            if ($evl_options["evl_bootstrap_slide{$n}"] == 1) {
                ...
                $bootstrap_slides['description'][$a] = 'Built-in Bootstrap Elements and Font Awesome let you do amazing things with your website';
                $bootstrap_slides['title'][$a] = 'Super Awesome WP Theme';
                $bootstrap_slides['enabled'][$a] = 1;
                $bootstrap_slides['image'][$a] = array(
                    'url' => "{$evolve_imagepathfolder}bootstrap-slider/1.jpg",
                    'id' => '',
                    'height' => '',
                    'width' => '',
                    'thumbnail' => '',
