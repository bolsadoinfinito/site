...
$evolve_custom_width_px                 = evolve_get_option( 'evl_custom_width_px', '' );
...
if ($evolve_width_px != "custom" && ( $evolve_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
$evolve_css_data .= '
...
@media (min-width: ' . $evolve_min_custom_width_100_px_padding . 'px) {
    .content .container .t4p-fullwidth .t4p-row {
...
if($evolve_page_title_bar_full_bg == 'yes' || $evolve_width_layout == 'fluid' || is_page_template('100-width.php')):
$evolve_css_data .= '
.page-title-container {
