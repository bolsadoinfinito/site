                ...
                <div class="row">
                    <div class="top-menu h4-menu center-menu" >
                        ...
                        if (has_nav_menu('top-menu')) {
                            ...
                            wp_nav_menu(array('theme_location' => 'top-menu', 'menu_class' => 'new-top-menu-cont nav-menu', 'menu_id' => '', 'depth' => 2, 'fallback_cb' => 'wp_page_menu', 'walker' => new evolve_Walker_Nav_Menu()));                            
                            echo '</nav>';
                        }
                        ?>
                    </div><!-- /.primary-menu -->
                        ...
                        <div class="primary-menu">
                            ...
                            if (has_nav_menu('primary-menu')) {
                                ...
                                if (evolve_get_option('evl_disable_megamenu', '0') == '0'):
                                    wp_nav_menu(array('theme_location' => 'primary-menu', 'menu_class' => 'nav-menu t4p-navbar-nav', 'fallback_cb' => 'wp_page_menu', 'walker' => new T4PCoreFrontendWalker()));
                                else:
                                    wp_nav_menu(array('theme_location' => 'primary-menu', 'menu_class' => 'nav-menu', 'menu_id' => '', 'fallback_cb' => 'wp_page_menu', 'walker' => new evolve_Walker_Nav_Menu()));
                                endif;
